...
J’ai ensuite modifié mon adresse IP manuellement. Les adresses utilisables dans ce réseau vont de 10.33.64.1 à 10.33.79.253, j’ai donc choisi une adresse libre dans cette plage et je l’ai configurée dans les paramètres IPv4 de Windows. Avant de faire ce changement, j’ai scanné le réseau avec la commande nmap -sn 10.33.64.0/20 afin d’éviter de prendre l’adresse IP d’un autre appareil déjà connecté.
